...
export function NewsCard({ item }: { item: LocalizedNewsItem }) {
  ...
  return (
    <GlassCard className="p-6 sm:p-8 h-full w-full">
      <button
        type="button"
      ...
      >
        ...
        >
          <p className="text-sm sm:text-[15px] leading-relaxed text-ink-muted whitespace-pre-line pt-3 border-t border-white/10 w-full">
            {item.content}
          </p>
        </div>
      </button>
